...
import com.THproject.tharidia_things.client.renderer.TrebuchetRenderer;
...
public class ClientModEvents {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.TREBUCHET.get(), TrebuchetRenderer::new);
        event.registerEntityRenderer(ModEntities.TREBUCHET_PROJECTILE.get(), ThrownItemRenderer::new);
    }
}
