...
/**
 * Hot Gold item created from casting molten gold into an ingot mold.
...
public class HotGoldItem extends Item {
    ...
    public HotGoldItem(Properties properties) {
        super(properties);
    }
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slotId, boolean isSelected) {
        // If hot gold somehow ends up in a player's inventory, remove it
