...
import com.tharidia.tharidia_things.character.CharacterEventHandler;
            ...
            .then(Commands.literal("character")
                ...
                .then(Commands.literal("reset")
                    .executes(context -> {
                        try {
                            ServerPlayer player = context.getSource().getPlayerOrException();
                            player.getData(com.tharidia.tharidia_things.character.CharacterAttachments.CHARACTER_DATA)
